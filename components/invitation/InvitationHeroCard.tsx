            ...
            <div className="relative z-10 px-2 sm:px-8 pb-2 flex flex-col items-center justify-evenly text-center w-full h-full">
              ...
              <div className="flex flex-col items-center w-full mt-4 sm:mt-6">
                ...
                >
                  ...
                  {!isEn && sinhalaGreeting && sinhalaGreeting !== "None" && (
                    <p
                      className="mt-1"
                      style={{
              ...
              <motion.button
                ...
                className="mt-2 sm:mt-3 flex items-center justify-center gap-2 sm:gap-4 cursor-pointer group focus:outline-none"
                initial={{ opacity: 0, y: 16 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="flex flex-col items-center px-2 sm:px-3 py-1">
                  <span
                    style={{
                      fontFamily: "var(--font-geist-sans)",
              ...
              <motion.button
                ...
                className="mt-2 sm:mt-3 flex flex-col items-center cursor-pointer group focus:outline-none"
              ...
              >
                <p
                  className="group-hover:text-wedding-primary transition-colors duration-200 underline"
                  style={{
                    fontFamily: isEn
                      ? "var(--font-geist-sans)"
                      : "var(--font-sinhala)",
